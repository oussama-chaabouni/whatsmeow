...
const file_waReporting_WAWebProtobufsReporting_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\rR\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.WAWebProtobufsReporting.FieldR\x05value:\x028\x01B'Z%github.com/oussama-chaabouni/whatsmeow/whatsmeow/proto/waReportingb\x06proto3"
